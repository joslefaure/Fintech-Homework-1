...
contract NFinTech is IERC721 {
    ...
    function setApprovalForAll(address operator, bool approved) external {
        ...
        require(operator != address(0), "ERC721: operator address is zero");
        require(msg.sender != operator, "ERC721: setting approval to self");
    ...
    function safeTransferFrom(address from, address to, uint256 tokenId) public {
        // Call the `safeTransferFrom` function with four arguments
